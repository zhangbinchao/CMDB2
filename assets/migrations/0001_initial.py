    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin', models.ForeignKey(blank=True, null=True, on_delete='on_delete', related_name='admin', to=settings.AUTH_USER_MODEL, verbose_name='资产管理员')),
                ('approved_by', models.ForeignKey(blank=True, null=True, on_delete='on_delete', related_name='approved_by', to=settings.AUTH_USER_MODEL, verbose_name='批准人')),
            ],
            options={
                'verbose_name': '资产总表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.OneToOneField(on_delete='on_delete', to='assets.Asset')),
            ],
            options={
                'verbose_name': 'CPU',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.ForeignKey(on_delete='on_delete', to='assets.Asset')),
            ],
            options={
                'verbose_name': '硬盘',
        ...
        migrations.AddField(
            model_name='asset',
            name='business_unit',
            field=models.ForeignKey(blank=True, null=True, on_delete='on_delete', to='assets.BusinessUnit', verbose_name='所属业务线'),
        ),
        migrations.AddField(
            model_name='asset',
            name='contract',
            field=models.ForeignKey(blank=True, null=True, on_delete='on_delete', to='assets.Contract', verbose_name='合同'),
        ),
        migrations.AddField(
            model_name='asset',
            name='idc',
            field=models.ForeignKey(blank=True, null=True, on_delete='on_delete', to='assets.IDC', verbose_name='所在机房'),
        ),
        migrations.AddField(
            model_name='asset',
            name='manufacturer',
            field=models.ForeignKey(blank=True, null=True, on_delete='on_delete', to='assets.Manufacturer', verbose_name='制造商'),
        ),
        migrations.AddField(
            model_name='asset',
            name='tags',
